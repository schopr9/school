$(function(){
	...
	function Adicionar(){
		$("#tblCadastro tbody").append(
			...
			"<td><input type='text'/></td>"+
			"<td><input type='text'/></td>"+
			"<td><img src='/assets/disk.png' class='btnSalvar'><img src='/assets/delete.png' class='btnExcluir'/></td>"+
			"</tr>");
	...
	function Editar(){
		...
		tdBotoes.html("<img src='/assets/disk.png' class='btnSalvar'/>");
	...
	function Salvar(){
		...
		tdBotoes.html("<img src='/assets/delete.png' class='btnExcluir'/><img src='/assets/pencil.png' class='btnEditar'/>");
